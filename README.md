...
## Тестирование
```text
Были реализованы интеграционные тесты, использующие отдельную тестовую базу данных PostgreSQL,
автоматический запуск и завершение контейнера осуществляется через библиотеку testcontainers-go,
в которую прогонялись миграции заполняющие бд тестовыми значениями.
```
...
| testcontainers-go        | автоматизация тестирования использующего настоящую бд      |
